 ...
 */
class Form extends \Administration\Entity\Form implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'title', 'formName', 'country', 'file');
        }
    ...
    public function setFormName($formName)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFormName', array($formName));
