 ...
 */
class Country extends \Administration\Entity\Country implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'countryId', 'name', 'languages');
        }
    ...
    public function setLanguages($language)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLanguages', array($language));

        return parent::setLanguages($language);
    }
